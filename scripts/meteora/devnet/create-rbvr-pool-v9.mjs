...
const ENV_FILE = path.join(
  PROJECT_ROOT,
  ".localnet/devnet-v9/rbvr-devnet.env",
);
...
async function main() {
  console.log("============================================================");
  console.log(" Rocket Beaver — Meteora DBC Devnet Deployment V9");
  console.log("============================================================");
  ...
  if (!shouldSend) {
    ...
    console.log(
      "RBVR_SEND=YES node scripts/meteora/devnet/create-rbvr-pool-v9.mjs",
    );
